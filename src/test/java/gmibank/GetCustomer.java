...
public class GetCustomer extends GmiBankBaseUrl {
    ...
    public void gmibankCustomer(){
        ...
        //Set the Url
        spec.pathParams("first","api","second","tp-customer","third",110472);
        ...
        Response response = given(spec).headers("Authorization","Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJiYXRjaF95dXp1YyIsImF1dGgiOiJST0xFX0FETUlOIiwiZXhwIjoxNjgwMDI5NjIwfQ.rbYhyIXexo5fMS5yYILzNTtWP53v5G_y1AbewlZa1Oweq2cyUjrGINoINPclMzCcVJ3YuoPMT_1AoL74UQrp2w").get("{first}/{second}/{third}");
